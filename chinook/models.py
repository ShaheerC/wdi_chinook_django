...
class Album(models.Model):
    ...
    created_at = models.DateTimeField(auto_now_add=True)
    updated_at = models.DateTimeField(auto_now=True)
    artist = models.ForeignKey(Artist, on_delete=models.CASCADE, related_name='album_artists')
...
class Track(models.Model):
    album = models.ForeignKey(Album, on_delete=models.CASCADE, related_name='track_albums')
    genre = models.ForeignKey(Genre, on_delete=models.CASCADE, related_name='track_genres')
    media_type = models.ForeignKey(MediaType, on_delete=models.CASCADE, related_name='track_mediatypes')
    name = models.CharField(max_length=255, null=False)
